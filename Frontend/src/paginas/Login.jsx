...
// creacion del grupo de "whatsapp = usecontext"
...
const Login = () => {
    // leer el contenido del mensaje auth y setAuth
    const {setAuth,setEstado} = useContext(AuthContext)
    const navigate = useNavigate()
    const [mensaje, setMensaje] = useState({})
    // capturar los datos del email y password
    ...
    // capturar los datos del formulario se ejecuta el endpoint (/login)
